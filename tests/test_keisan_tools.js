...
test("index.html が道具系 6 script を k5_devs_data と app.js の間に順番どおり読む", () => {
  ...
  assert.deepEqual(srcs.slice(at + 1, at + 9), [
    "../shared/economy_flag.js?v=0.4.0",
    "../shared/species_guilds.js?v=0.1.1",
    "../shared/tools.js?v=0.2.6",
    "../shared/tool_icons.js?v=0.2.1",
...
test("index.html が shared/tools.css を読む", () => {
  assert.match(indexHtml, /<link rel="stylesheet" href="\.\.\/shared\/tools\.css\?v=0\.1\.4">/,
