...
var LEVEL_GUIDE={
  hissan:["2けた＋1けた","2けた＋2けた","くり上がりあり","2けた標準","2けた発展","3けた入門","3けた標準","3けた発展","大きめ3けた","4けた"],
  hikizan:["2けた−1けた","2けた−2けた","くり下がりあり","2けた標準","2けた発展","3けた入門","3けた標準","3けた発展","大きめ3けた","4けた"],
  kuku:["2の段","5の段","3の段","4の段","6の段","7の段","8の段","9の段","1の段","全段ミックス"],
  anzan:["1けた中心","2けた加減","かけ算入り","わり算入り","2段階計算","3けた加減","きりのいいかけ算","割り切れるわり算","2けた×2けた入門","暗算総合"],
  warizan:["九九でわる","2けた÷1けた","割り切れる2けた","あまりあり2けた","3けた÷1けた","商が大きい","あまりあり3けた","2けたでわる","2けたでわる発展","商とあまり総合"],
  kufuu:["25×4型","125×8型","順番を入れ替える","まとまりを作る","きりのいい数","分配法則入門","分配法則標準","大きめの工夫","複合工夫","総合チャレンジ"],
  deci:["小数のたし算","小数のひき算","小数1けた×整数","小数2けたの加減","小数÷整数","単位換算入り","小数の混合","大きめの小数","文章題入り","小数総合"],
  frac:["同分母の加減","約分入門","異分母入門","帯分数なし標準","異分母標準","かけ算入門","わり算入門","四則混合","帯分数入り","分数総合"],
  ...
  shigoto:["1日分の仕事","全体を1と見る","2人で作業","日数を求める","途中交代","片方の速さ","休み入り","条件2つ","複合仕事","仕事算総合"],
  nenrei:["年齢差","何年後","何年前","親子の年齢","倍になる時","和と差","3人の年齢","年齢の比","複合条件","年齢算総合"],
  ueki:["両端に植える","両端に植えない","円形に植える","間の数","全長を求める","間隔を求める","本数を求める","周回条件","複合条件","植木算総合"],
  ryuusui:["静水と流れ","下りの速さ","上りの速さ","時間を求める","距離を求める","流速を求める","往復","いかだ","複合条件","流水算総合"],
  tsuuka:["列車と柱","列車と橋","列車同士","長さを求める","速さを求める","時間差","追い越し","すれ違い","複合条件","通過算総合"],
  ...
  hayasahi:["速さの比","時間の比","距離の比","同じ距離","同じ時間","比で速さを求める","旅人算接続","往復と比","複合条件","速さと比総合"],
  ...
  shoukyo:["同じものを消す","差を作る","2式の整理","係数をそろえる","代入入門","代入標準","3量入門","3量標準","複合条件","消去算総合"],
  ...
  hireihanpi:["比例の意味","比例の計算","反比例の意味","反比例の計算","表で整理","式で整理","単位量あたり","逆算","複合条件","比例反比例総合"]
};
