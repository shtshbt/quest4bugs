(function(global){
  ...
  /* 採集道具 (tools_design 6-8 章)。メダル 1 枚と交換で授かる消耗品で、動かすのは
     ...
     `shared/species_guilds.js` (Q4B_GUILDS) がギルドを分類から導き、道具は
     `guildKey` で 1 つを指すだけにしてある (2026-09-06 分離)。道具を増やす作業と、
     図鑑の種をギルドへ割り当てる作業を別々にレビューできるようにするため。
     道具とギルドは 1 対 1 で、いまは 15 組ある。 */
  ...
  var TOOLS=[
    ...
    /* 第 2 波 (2026-09-06 決定。tools_design 6.3)。11 種で打ち止めという当初の
       決定は、ギルド軸がまだ空いていたぶんだけ広げた。マレーゼと材割りが更新 6、
       サーバーネットと衝突板が更新 7 で、各更新に 小道で働くもの 1 本と 本編で
       働くもの 1 本を組にしてある。 */
    {
      id:"malaise_trap",name:"マレーゼトラップ",emoji:"⛺",release:6,
      guildKey:"malaise",
      blurb:"みちに はった あみの テント。とんできた ハチや ハエが うえへ のぼって つかまる。",
      breakText:"テントが やぶれた!"
    },
    {
      id:"deadwood_set",name:"材割りセット",yomi:"ざいわりセット",emoji:"🪓",release:6,
      guildKey:"deadwood",
      blurb:"くちた きを そっと わる おのと タガネ。きの 中で くらす 虫が でてくる。",
      breakText:"タガネが かけた!"
    },
    {
      id:"surber_net",name:"サーバーネット",emoji:"🌊",release:7,
      guildKey:"stream",
      blurb:"せせらぎの いしを おこして うける あみ。ながれてきた 虫が あみに はいる。",
      breakText:"あみが やぶれた!"
    },
    {
      id:"window_trap",name:"衝突板トラップ",yomi:"しょうとつばんトラップ",emoji:"🪟",release:7,
      guildKey:"flight_beetle",
      blurb:"そらに たてた すきとおった いた。ぶつかった 虫が した の うけざらに おちる。",
      breakText:"いたが われた!"
    }
  ];
