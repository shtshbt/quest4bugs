(function(global){
  ...
  /* 採集道具のアイコン (tools_design 9 章)。道具 1 本につき 1 枚で、いまは 15 枚。一色〜二色のライン画で、
  ...
  var ICONS={
    ...
    /* マレーゼトラップ: 飛行路に張る あみの テント。てっぺんの角に あつめる びん。 */
    malaise_trap:'<path d="M2.8 19.8 L12 5.2 L21.2 19.8"/>'
      +'<path d="M2.8 19.8 H21.2"/>'
      +'<rect x="10.3" y="1.6" width="3.4" height="3.8" rx="1"/>'
      +'<path class="tool-icon-accent" d="M6.6 19.8 L12 11.2 L17.4 19.8 M7.8 15.4 H16.2"/>',
    /* 材割りセット: 丸太に あてた おの。木くずが 2 色目。 */
    deadwood_set:'<path d="M3.2 20.6 L12.6 11.2"/>'
      +'<path d="M11.4 10 L15.4 6 C18 6.8 20 8.8 20.8 11.4 L16.8 15.4 Z"/>'
      +'<path class="tool-icon-accent" d="M4.6 8.6 L6.8 6.4 M8.4 5.4 L9 2.8 M2.4 12.4 L0.6 11"/>',
    /* サーバーネット: せせらぎに たてた わくつきの あみ。ながれが 2 色目。 */
    surber_net:'<path d="M5.4 4.8 V17.6"/>'
      +'<path d="M5.4 6.2 H14.2 L11.8 14.8 H5.4"/>'
      +'<circle cx="18.4" cy="15.6" r="2.4"/>'
      +'<path class="tool-icon-accent" d="M1.6 20.4 C4.6 18.8 7.6 21.6 10.6 20 C13.6 18.4 16.6 21.2 19.6 19.6"/>',
    /* 衝突板トラップ: そらに たてた すきとおった いたと、した の うけざら。 */
    window_trap:'<rect x="5.8" y="2.4" width="12.4" height="10.8" rx="1"/>'
      +'<path d="M12 2.4 V13.2"/>'
      +'<path d="M5 16.6 H19 L17.4 20.8 H6.6 Z"/>'
      +'<path class="tool-icon-accent" d="M9 6.4 L9.9 7.3 M15 5.4 L15.9 6.3 M12 14.4 V16.2"/>'
  };
